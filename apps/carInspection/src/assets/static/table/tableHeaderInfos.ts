...
> = [
  {
    key: "frameEngineNumber",
    label: LANGUAGE_LABEL.FRAME_ENGINE_NUMBER,
    columnWidth: "244px",
  },
  {
    key: "modelInformation",
    label: LANGUAGE_LABEL.MODEL_INFORMATION,
    columnWidth: ["434px", "auto"],
  },
];
...
> = [
  ...
  {
    key: "inspectionItem",
    label: LANGUAGE_LABEL.INSPECTION_ITEM,
    columnWidth: ["394px", "auto"],
  },
